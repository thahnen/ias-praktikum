...
printf "\nUEBERPRUEFT WIRD 127.0.0.1:8080/aussteller\n"
printf "HTTP-Methoden: GET:\n"
printf "==================\n"

printf "\nGET http://127.0.0.1:8080/aussteller:\n"
printf "HTTP-Rueckgabe-Code: "
echo $(curl -s -o /dev/null -w "%{http_code}" http://127.0.0.1:8080/aussteller)
#printf "\nZurueckgegebene JSON-Daten: "
#curl -s http://127.0.0.1:8080/aussteller
